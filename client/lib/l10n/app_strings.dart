...
class AppStrings {
  ...
  _catalog = <String, Map<String, String>>{
    'en': <String, String>{
      ...
      'info.matchDetail.noGames': 'No games in this match.',
      'info.matchDetail.message':
      ...
      'history.exportDialogTitle': 'Export History (.txt)',
      'history.importDialogTitle': 'Import History (.txt)',
      'history.importHint': 'Paste exported .txt content here',
      'history.noValidRecords': 'No valid duel records found.',
      'history.importedCount': '{count} duel(s) imported.',
      'history.importFailed': 'Import failed. Invalid .txt history format.',
      'history.renameGame': 'Rename game',
      'history.gameNameHint': 'Game name',
      'history.deleteGame': 'Delete game',
      'history.deleteGameConfirm': 'Delete "{title}" from history?',
      'history.games': 'Games',
      'history.gameResultNone': 'No result',
      'history.atLeastOneResult': 'At least one game result is required.',
      'history.matchPrefix': 'Match',
      'history.mtgMatchPrefix': 'MTG Match',
      'history.gamePrefix': 'Game',
      'history.mtgGamePrefix': 'MTG Game',
      'history.resultHint': 'Result',
      'history.deleteDuelTooltip': 'Delete duel',
      'history.noLpHistory': 'No life point history saved for this game yet.',
      'history.exportCopied': 'History text copied. Save it as a .txt file.',
      'deckList.sortFilter': 'Sort/filter',
      'deckList.sortBy': 'Sort decks by',
      'deckList.filters': 'Deck filters',
      'sideboardPlans.sortFilter': 'Sort/filter',
      'sideboardPlans.searchByName': 'Search by name...',
      ...
      'deckList.searchByName': 'Search by name...',
      'deckForm.nameRequired': 'Deck name is required.',
      'deckForm.nameConflict': 'A deck with this name already exists.',
      'deckForm.mismatchTitle': 'Format mismatch',
      'deckForm.mismatchBody':
          'The match is using format "{matchFormat}" but the deck is being created with "{deckFormat}". Which format should the deck use?',
      'deckForm.useMatchFormat': 'Use "{format}"',
      'deckForm.useDeckFormat': 'Use "{format}"',
      'deckForm.selectionClearedOnFormatChange':
      ...
      'sideboard.deleteDeck': 'Delete deck',
      'sideboard.deleteDeckTitle': 'Delete deck?',
      'sideboard.deleteDeckBody': 'Delete "{name}"? This cannot be undone.',
      'account.title': 'Account (Coming soon)',
      ...
      'account.apiSection': 'API status',
      'account.apiOnline': 'API online',
      'account.apiOffline': 'API unreachable',
      'account.apiChecking': 'Checking...',
      'common.yes': 'Yes',
      'common.no': 'No',
    ...
    'it': <String, String>{
      ...
      'info.matchDetail.message':
          'Modificare un match cambia solo i metadati. Il risultato del match viene calcolato dai risultati dei game di seguito.',
      'info.matchDetail.noGames': 'Questo match non contiene game.',
      ...
      'history.exportDialogTitle': 'Esporta Cronologia (.txt)',
      'history.importDialogTitle': 'Importa Cronologia (.txt)',
      'history.importHint': 'Incolla qui il contenuto .txt esportato',
      'history.noValidRecords': 'Nessun record valido trovato.',
      'history.importedCount': '{count} duel importati.',
      'history.importFailed': 'Importazione fallita. Formato .txt non valido.',
      'history.renameGame': 'Rinomina partita',
      'history.gameNameHint': 'Nome partita',
      'history.deleteGame': 'Elimina partita',
      'history.deleteGameConfirm': 'Eliminare "{title}" dalla cronologia?',
      'history.games': 'Game',
      'history.gameResultNone': 'Nessun risultato',
      'history.atLeastOneResult': 'Almeno un risultato di game è richiesto.',
      'history.matchPrefix': 'Match',
      'history.mtgMatchPrefix': 'MTG Match',
      'history.gamePrefix': 'Game',
      'history.mtgGamePrefix': 'MTG Game',
      'history.resultHint': 'Risultato',
      'history.deleteDuelTooltip': 'Elimina duello',
      'history.noLpHistory': 'Nessuno storico punti vita per questa partita.',
      'history.exportCopied': 'Testo copiato. Salvalo come file .txt.',
      'deckList.sortFilter': 'Ordina/filtra',
      'deckList.sortBy': 'Ordina i deck per',
      'deckList.filters': 'Filtri deck',
      'sideboardPlans.sortFilter': 'Ordina/filtra',
      'sideboardPlans.searchByName': 'Cerca per nome...',
      ...
      'deckList.searchByName': 'Cerca per nome...',
      'deckForm.nameRequired': 'Il nome del deck è obbligatorio.',
      'deckForm.nameConflict': 'Esiste già un deck con questo nome.',
      'deckForm.mismatchTitle': 'Formato non coerente',
      'deckForm.mismatchBody':
          'Il match usa il formato "{matchFormat}" ma il deck viene creato con "{deckFormat}". Quale formato usare per il deck?',
      'deckForm.useMatchFormat': 'Usa "{format}"',
      'deckForm.useDeckFormat': 'Usa "{format}"',
      'deckForm.selectionClearedOnFormatChange':
      ...
      'sideboard.deleteDeck': 'Elimina mazzo',
      'sideboard.deleteDeckTitle': 'Eliminare mazzo?',
      'sideboard.deleteDeckBody':
          'Eliminare "{name}"? Operazione non reversibile.',
      ...
      'account.apiSection': 'Stato API',
      'account.apiOnline': 'API online',
      'account.apiOffline': 'API non raggiungibile',
      'account.apiChecking': 'Verifica...',
      'common.yes': 'Sì',
      'common.no': 'No',
      ...
      'mtg.setup.tableModeOnly':
          'Per 2 giocatori è disponibile solo il Table Mode.',
